<?php
	...
	$nt_agricom_wsh				= 	ot_get_option( 'nt_agricom_page_woo_heading' );
	$nt_agricom_wsd				= 	ot_get_option( 'nt_agricom_page_woo_desc' );
	$nt_agricom_wshd 			= 	ot_get_option( 'nt_agricom_page_woo_heading_display' );
	$nt_agricom_wsdd 			= 	ot_get_option( 'nt_agricom_page_woo_desc_display' );
	$nt_agricom_post_layout 	= 	ot_get_option( 'woopage_layout' );
