...
// to use with intents
    ...
    foreach ( $tweets as $tweet ) {
        ...
        <div class="tfa-single-tweet-wrapper">
            <div class="tfa-shadow"><span class="tfa-shadow-tleft"></span><span class="tfa-shadow-tmid"></span><span class="tfa-shadow-tright"></span></div>
            <div class="tfa-tweet-content">
                <div class="tfa-body-content">
                    <span class="tfa-tweet-quote-left">"</span>
                    <?php
                     if ( $tweet->full_text ) {
                        ...
                        echo $the_tweet . ' ';
                        ?>
                        <span class="tfa-tweet-quote-right">"</span>
                    </div>
                    <div class="tfa-user-info tfa-header-content">
                        ...
                        <div class="tfa-subheader-content">
                            <i class="fa fa-twitter"></i><span class="tfa-screenName"><?php echo $tweet->user->name; ?></span>
                            <?php if ( $username_link_status == true ) { ?>
            ...
            <?php if ( isset( $tfa_vc_settings['display_twitter_actions'] ) && $tfa_vc_settings['display_twitter_actions'] == 1 ) { ?>
                ...
                <!--Tweet Action -->
            <?php } ?>
            <div class="tfa-shadow"><span class="tfa-shadow-left"></span><span class="tfa-shadow-mid"></span><span class="tfa-shadow-right"></span></div>
