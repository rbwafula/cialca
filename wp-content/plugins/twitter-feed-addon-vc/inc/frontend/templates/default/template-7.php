    ...
    foreach ( $tweets as $tweet ) {
        ...
        <div class="tfa-single-tweet-wrapper">
            <div class="tfa-tweet-content">
                <div class="tfa-header-content">
                    <?php if ( $username_link_status == true ) { ?>
                        <a href="http://twitter.com/<?php echo $tweet->user->screen_name; ?>" class="tfa-tweet-name" target="_blank">
                            ...
                            <span class="tfa-screen-name"><?php echo $tweet->user->name; ?></span> <span class="tfa-user-name">@<?php echo $tweet->user->screen_name; ?></span>
                        </a>
                    <?php } ?>
                ...
                <div class="tfa-tweet-box tfa-body-content">
                    <?php
                    if ( $tweet->full_text ) {
