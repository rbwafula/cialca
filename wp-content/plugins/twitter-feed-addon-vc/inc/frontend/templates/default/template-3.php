        ...
        <div class="tfa-single-tweet-wrapper">
            <div class="tfa-tweet-content">
                <div class="tfa-header-content">
                    <?php if ( $username_link_status == true ) { ?><a href="http://twitter.com/<?php echo $tweet->user->screen_name; ?>" target="_blank"><img src="<?php echo str_replace('http://','https://',$tweet->user->profile_image_url); ?>" height="50px" width="50px"/><span class="tfa-display-name"><?php echo $tweet->user->name; ?></span></a><?php } ?>
