    ...
    foreach ($tweets as $tweet) {
        ...
        <div class="tfa-single-tweet-wrapper">
            <div class="tfa-tweet-content">
                <div class="tfa-tweet-header tfa-header-content">
                    <?php if ($username_link_status == true) { ?>
                        <a href="http://twitter.com/<?php echo $username; ?>" class="tfa-tweet-name" target="_blank">
                            <img src="<?php echo str_replace('http://','https://',$tweet->user->profile_image_url); ?>" height="50px" width="50px"/>
                            <span class="tfa-display-name"><?php echo $tweet->user->name; ?></span>
                            <span class="tfa-tweet-username"><?php echo '@' . $tweet->user->screen_name; ?></span> 
                        </a>
                    <?php } ?>
