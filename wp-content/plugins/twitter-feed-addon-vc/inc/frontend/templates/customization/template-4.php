...
<style type="text/css">
	...
	<?php if (!empty($link_color)): ?>
		.<?=$customization_class ?> .tfa-tweet-content .tfa-body-content a{
	...
	<?php if (!empty($username_color)): ?>
		.<?=$customization_class ?> .tfa-tweet-content .tfa-display-name{
			color: <?=$username_color ?> !important	
		}
	<?php endif ?>

	<?php if (!empty($username_link_color)): ?>
		.<?=$customization_class ?> .tfa-tweet-content .tfa-tweet-username{
