<div class="tfa-single-board-wrapper" id="tfa-morewp-board" style="display:none">
    <h3 class="tfa-title"><?php _e('More WordPress Resources', TFA_VC_DOMAIN); ?></h3>
    <div>
           <p><strong>Twitter Feed Addon for Visual Composer</strong> works best with every WordPress theme. It's even more remarkable when used with popular themes like VMagazine and AccessPress Parallax.</p>
